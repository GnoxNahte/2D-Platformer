...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        timeSinceJumpPressed = realtime - lastJumpPressed;
        timeSinceLastJump = realtime - lastJumpTime;
        timeSinceLastOnPlatform = realtime - lastGroundedTime;
    }
